...
<table>
<tr>
<td width="50%"><img src="docs/images/board-list.png"><br><sub>게시판 — 코드 첨부 글쓰기·댓글</sub></td>
<td width="50%"><img src="docs/images/chat-websocket.png"><br><sub>실시간 채팅 (WebSocket)</sub></td>
</tr>
<tr>
<td><img src="docs/images/chatbot-1.png"><br><sub>AI 챗봇 (Dialogflow)</sub></td>
<td><img src="docs/images/point-charge.png"><br><sub>포인트 충전 (카카오페이)</sub></td>
</tr>
<tr>
<td><img src="docs/images/attendance-calendar.png"><br><sub>출석체크 + 포인트</sub></td>
<td><img src="docs/images/code-ui-gallery.png"><br><sub>코드 / UI 컴포넌트 공유</sub></td>
</tr>
</table>
